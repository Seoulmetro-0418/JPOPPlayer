...
struct SongLibrary_ko {
    static let songs: [Song] = [
        ...
        Song(title: "지구본(地球儀)",
             ...
             lyrics: [
                (0.0, "지구본- 요네즈 켄시"),
                (15.0, "보쿠가 우마레타 히노 소라와"),
                (22.0, "타카쿠 토오쿠 하레와탓테이타"),
                (30.0, "잇테 오이데토 세나카오 나데루"),
                (37.0, "코에오 키이타 아노 히"),
                (44.0, "키세츠노 나카데 스레치가이"),
                (51.0, "토키니 히토오 키즈츠케가라"),
                (59.0, "히카리니 후레테"),
                ...
                (104.0, "아키타라즈 오모이하세루"),
                (107.0, "치큐-기오 마와스요-니"),
                (122.0, "보쿠가 아이시타 아노 히토와"),
                (130.0, "다레모 시라나이 토코로에 잇타"),
                (138.0, "아노 히노 마마노"),
                (142.0, "야사시이 카오데"),
                (145.0, "이마모 도코카 토오쿠"),
                (154.0, "아메오 우케 우타이다스"),
